...
public class OI {
	...
	public static boolean tiltUpButton = stick.getRawButton(RobotMap.STICK_LEFT_UPPER_BUTTON_ID);
	public static boolean tiltDownButton = stick.getRawButton(RobotMap.STICK_LEFT_LOWER_BUTTON_ID);
